...
void MPU9250Calibrator::log_sensors(const SMotion6& s) const {
    Serial.print("ax: "); Serial.print(s.a.x); Serial.print(", ");
    Serial.print("ay: "); Serial.print(s.a.y); Serial.print(", ");
    Serial.print("az: "); Serial.print(s.a.z); Serial.print(", ");

    Serial.print("gx: "); Serial.print(s.g.x); Serial.print(", ");
    Serial.print("gy: "); Serial.print(s.g.y); Serial.print(", ");
    Serial.print("gz: "); Serial.print(s.g.z);
